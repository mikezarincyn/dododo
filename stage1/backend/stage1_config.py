...
# Этап G: внешний демо-гейт (DODODO_DEMO_PASSWORD / HTTP Basic поверх всего) удалён.
# Единственная защита — внутренний email/password-вход (сессия) на уровне эндпоинтов.
