...
# Этап G: внешний демо-гейт (BasicGateMiddleware / install_basic_gate) УДАЛЁН.
# Единственная защита — внутренний email/password-вход (сессия) на уровне
# эндпоинтов (require_parent / require_reviewer / require_admin). См. main.py.
