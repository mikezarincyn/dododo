...
def sandbox(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(cfg, "USERS_DIR", data / "users", raising=False)
    monkeypatch.setattr(cfg, "SESSIONS_DIR", data / "sessions", raising=False)
    monkeypatch.setattr(cfg, "RESET_TOKENS_DIR", data / "reset_tokens", raising=False)
